...
par(mfrow=c(4,2))
plot(gam_raw_qd_white_female, all.teqds = FALSE, trans=exp, shift=0.05, ylab="White female HR")
plot(gam_raw_qd_white_male, all.teqds = FALSE, trans=exp, shift=0.05, ylab="White male HR")
plot(gam_raw_qd_black_female, all.teqds = FALSE, trans=exp, shift=0.05, ylab="Black female HR")
plot(gam_raw_qd_black_male, all.teqds = FALSE, trans=exp, shift=0.05, ylab="Black male HR")
plot(gam_raw_qd_hispanic_female, all.teqds = FALSE, trans=exp, shift=0.05, ylab="Hispanic female HR")
plot(gam_raw_qd_hispanic_male, all.teqds = FALSE, trans=exp, shift=0.05, ylab="Hispanic male HR")
plot(gam_raw_qd_asian_female, all.teqds = FALSE, trans=exp, shift=0.05, ylab="Asian female HR")
plot(gam_raw_qd_asian_male, all.teqds = FALSE, trans=exp, shift=0.05, ylab="Asian male HR")
