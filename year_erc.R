...
mclapply(1:nrow(scenarios), function(i, ...) {
  ...
  sub_data <- subset(aggregate_data, race %in% race0 & year %in% year0)
  ...
  save(new_data, file = paste0(dir_out, scenario$race, "_", scenario$years, ".RData"))
