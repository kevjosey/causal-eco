...
align <- align_plots(a_hist_sens, erf_plot_sens, align = "hv", axis = "tblr")
...
load("/nfs/nsaph_ci3/ci3_analysis/josey_erc_strata/Output/SuperLearner/DR_qd/2_all_qd.RData")
