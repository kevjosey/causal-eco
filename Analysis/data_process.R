...
national_merged2016_qd$age_break <- cut(national_merged2016_qd$age, c(65,75,85,95,125), right = FALSE)
...
national_merged2016_rm$age_break <- cut(national_merged2016_rm$age, c(65,75,85,95,125), right = FALSE)
