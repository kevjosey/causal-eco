...
load(paste0(dir_data,"covariates_rm_low.RData"))
load(paste0(dir_data,"aggregate_data_rm_low.RData"))
aggregate_data_rm<-merge(aggregate_data_rm,covariates_rm,by=c("zip","year"),all.x=T)

load(paste0(dir_data,"covariates_qd_low.RData"))
load(paste0(dir_data,"aggregate_data_qd_low.RData"))
...
save(Poisson_qd, Poisson_qd_asian, Poisson_qd_asian_female,Poisson_qd_asian_male, 
     ...
     Poisson_rm_white, Poisson_rm_white_female, 
      Poisson_rm_white_male, file= "/nfs/nsaph_ci3/ci3_analysis/pdez_measurementerror/Output/Poisson/Main_low.RData")
