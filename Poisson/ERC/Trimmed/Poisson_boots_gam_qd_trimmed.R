...
aggregate_data_qd<-subset(aggregate_data_qd, aggregate_data_qd$pm25_ensemble < quantile(aggregate_data_qd$pm25_ensemble, 0.95) &
aggregate_data_qd$pm25_ensemble > quantile(aggregate_data_qd$pm25_ensemble, 0.05))
...
save(test,file=paste0(dir_out,"gam1_boots_qd_all_trimmed.RData"))
rm(test, gam_raw)
gc()
stopCluster(cl)
...
white_female_qd<-subset(white_female_qd, white_female_qd$pm25_ensemble < quantile(white_female_qd$pm25_ensemble, 0.95) &
white_female_qd$pm25_ensemble > quantile(white_female_qd$pm25_ensemble, 0.05))
...
save(test,file=paste0(dir_out,"gam1_boots_qd_white_female_trimmed.RData"))
rm(gam_raw, test)
gc()
...
white_male_qd<-subset(white_male_qd, white_male_qd$pm25_ensemble < quantile(white_male_qd$pm25_ensemble, 0.95) &
white_male_qd$pm25_ensemble > quantile(white_male_qd$pm25_ensemble, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_qd_white_male_trimmed.RData"))
gc()
...
black_qd_female<-subset(black_qd_female, black_qd_female$pm25_ensemble < quantile(black_qd_female$pm25_ensemble, 0.95) &
black_qd_female$pm25_ensemble > quantile(black_qd_female$pm25_ensemble, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_qd_black_female_trimmed.RData"))
rm(test)
gc()
...
black_qd_male<-subset(black_qd_male, black_qd_male$pm25_ensemble < quantile(black_qd_male$pm25_ensemble, 0.95) &
black_qd_male$pm25_ensemble > quantile(black_qd_male$pm25_ensemble, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_qd_black_male_trimmed.RData"))
rm(test)
gc()
...
hispanic_qd_female<-subset(hispanic_qd_female, hispanic_qd_female$pm25_ensemble < quantile(hispanic_qd_female$pm25_ensemble, 0.95) &
hispanic_qd_female$pm25_ensemble > quantile(hispanic_qd_female$pm25_ensemble, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_qd_hispanic_female_trimmed.RData"))
gc()
...
hispanic_qd_male<-subset(hispanic_qd_male, hispanic_qd_male$pm25_ensemble < quantile(hispanic_qd_male$pm25_ensemble, 0.95) &
hispanic_qd_male$pm25_ensemble > quantile(hispanic_qd_male$pm25_ensemble, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_qd_hispanic_male_trimmed.RData"))
gc()
...
asian_qd_female <-subset(asian_qd_female, asian_qd_female$pm25_ensemble < quantile(asian_qd_female$pm25_ensemble, 0.95) &
asian_qd_female$pm25_ensemble > quantile(asian_qd_female$pm25_ensemble, 0.05))
...
save(test,file=paste0(dir_out,"gam1_boots_qd_asian_female_trimmed.RData"))
gc()
...
asian_qd_male <-subset(asian_qd_male, asian_qd_male$pm25_ensemble < quantile(asian_qd_male$pm25_ensemble, 0.95) &
asian_qd_male$pm25_ensemble > quantile(asian_qd_male$pm25_ensemble, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_qd_asian_male_trimmed.RData"))
gc()
}
