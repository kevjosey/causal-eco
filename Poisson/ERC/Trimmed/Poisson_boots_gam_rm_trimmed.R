...
aggregate_data_rm<-subset(aggregate_data_rm, aggregate_data_rm$pm25 < quantile(aggregate_data_rm$pm25, 0.95) &
aggregate_data_rm$pm25 > quantile(aggregate_data_rm$pm25, 0.05))
...
for (boots_id in 1:500){
  ...
  gam_raw<-mgcv::bam(dead~  s(pm25, bs='cr',  k=3) + 
...
save(test,file=paste0(dir_out,"gam1_boots_rm_all_trimmed.RData"))
rm(test, gam_raw)
gc()
stopCluster(cl)
...
white_female_rm<-subset(white_female_rm, white_female_rm$pm25 < quantile(white_female_rm$pm25, 0.95) &
white_female_rm$pm25 > quantile(white_female_rm$pm25, 0.05))
...
save(test,file=paste0(dir_out,"gam1_boots_rm_white_female_trimmed.RData"))
rm(gam_raw, test)
gc()
...
white_male_rm<-subset(white_male_rm, white_male_rm$pm25 < quantile(white_male_rm$pm25, 0.95) &
white_male_rm$pm25 > quantile(white_male_rm$pm25, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_rm_white_male_trimmed.RData"))
gc()
...
black_rm_female<-subset(black_rm_female, black_rm_female$pm25 < quantile(black_rm_female$pm25, 0.95) &
black_rm_female$pm25 > quantile(black_rm_female$pm25, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_rm_black_female_trimmed.RData"))
rm(test)
gc()
...
black_rm_male<-subset(black_rm_male, black_rm_male$pm25 < quantile(black_rm_male$pm25, 0.95) &
black_rm_male$pm25 > quantile(black_rm_male$pm25, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_rm_black_male_trimmed.RData"))
rm(test)
gc()
...
hispanic_rm_female<-subset(hispanic_rm_female, hispanic_rm_female$pm25 < quantile(hispanic_rm_female$pm25, 0.95) &
hispanic_rm_female$pm25 > quantile(hispanic_rm_female$pm25, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_rm_hispanic_female_trimmed.RData"))
gc()
...
hispanic_rm_male<-subset(hispanic_rm_male, hispanic_rm_male$pm25 < quantile(hispanic_rm_male$pm25, 0.95) &
hispanic_rm_male$pm25 > quantile(hispanic_rm_male$pm25, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
save(test,file=paste0(dir_out,"gam1_boots_rm_hispanic_male_trimmed.RData"))
gc()
...
asian_rm_female <-subset(asian_rm_female, asian_rm_female$pm25 < quantile(asian_rm_female$pm25, 0.95) &
asian_rm_female$pm25 > quantile(asian_rm_female$pm25, 0.05))
...
save(test,file=paste0(dir_out,"gam1_boots_rm_asian_female_trimmed.RData"))
gc()
...
asian_rm_male <-subset(asian_rm_male, asian_rm_male$pm25 < quantile(asian_rm_male$pm25, 0.95) &
asian_rm_male$pm25 > quantile(asian_rm_male$pm25, 0.05))
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
...
for (boots_id in 1:500){
  ...
  try({gam_raw<-mgcv::bam(dead~  s(pm25, bs='cr',  k=3) + 
                            as.factor(dual)+as.factor(entry_age_break)+as.factor(followup_year)+
                            mean_bmi + smoke_rate + hispanic+ pct_blk +
                            medhouseholdincome + medianhousevalue +
                            poverty + education + popdensity + pct_owner_occ +
  ...
  test<-cbind(test, test.data.rm(aggregate_data_boots, gam_raw))}, silent=TRUE)
  print(boots_id)
  rm(aggregate_data_boots)
}
stopCluster(cl)

save(test,file=paste0(dir_out,"gam1_boots_rm_asian_male_trimmed.RData"))
gc()
}
