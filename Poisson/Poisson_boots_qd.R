...
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
aggregate_data.list<-split(white_qd, list(white_qd$zip))
num_uniq_zip <- length(unique(white_qd$zip))
...
stopCluster(cl)
save(loglinear_coefs_boots_white,file=paste0(dir_out,"loglinear_coefs_boots_qd_white.RData"))
rm(white_qd)
gc()
...
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
aggregate_data.list<-split(black_qd, list(black_qd$zip))
num_uniq_zip <- length(unique(black_qd$zip))
...
stopCluster(cl)
save(loglinear_coefs_boots_black,file=paste0(dir_out,"loglinear_coefs_boots_qd_black.RData"))
rm(black_qd)
gc()
...
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
aggregate_data.list<-split(hispanic_qd, list(hispanic_qd$zip))
num_uniq_zip <- length(unique(hispanic_qd$zip))
...
stopCluster(cl)
save(loglinear_coefs_boots_hispanic, file=paste0(dir_out,"loglinear_coefs_boots_qd_hispanic.RData"))
rm(hispanic_qd)
gc()
...
cl=makeCluster(20,outfile='')
registerDoParallel(cl)
aggregate_data.list<-split(asian_qd, list(asian_qd$zip))
num_uniq_zip <- length(unique(asian_qd$zip))
...
stopCluster(cl)
save(loglinear_coefs_boots_asian, file=paste0(dir_out,"loglinear_coefs_boots_qd_asian.RData"))
rm(asian_qd)
gc()
