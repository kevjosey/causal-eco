...
q1<-quantile(prematch_data$pm25, 0.05)
q2<-quantile(prematch_data$pm25, 0.95)
...
save(match_pop_all_noncompile_notrim, match_pop_all_noncompile_onehot, match_pop_all_noncompile_trim,
     ...
     file='/nfs/home/P/prd789/shared_space/ci3_analysis/pdez_measurementerror/National_Causal-master/gpscausal_rm_strata_trim5.RData'
)
#Plots
#all
require(ggplot2)
