...
#All
prematch_data<-prematchdata(aggregate_data_rm, covariates_rm)
...
q1<-quantile(prematch_data$pm25, 0.01)
q2<-quantile(prematch_data$pm25, 0.99)
...
#Strata
#White female
prematch_data<-prematchdata(white_female_rm, covariates_white_female_rm)
...
#White male
prematch_data<-prematchdata(white_male_rm, covariates_white_male_rm)
...
#Black female
prematch_data<-prematchdata(black_female_rm, covariates_black_female_rm)
...
#Black male
prematch_data<-prematchdata(black_male_rm, covariates_black_male_rm)
...
#Hispanic female
prematch_data<-prematchdata(hispanic_female_rm, covariates_hispanic_female_rm)
...
#Hispanic male
prematch_data<-prematchdata(hispanic_male_rm, covariates_hispanic_male_rm)
...
#Asian female
prematch_data<-prematchdata(asian_female_rm, covariates_asian_female_rm)
...
#Asian male
prematch_data<-prematchdata(asian_male_rm, covariates_asian_male_rm)
...
save(match_pop_all_noncompile_notrim, match_pop_all_noncompile_onehot, match_pop_all_noncompile_trim,
     ...
     file='/nfs/home/P/prd789/shared_space/ci3_analysis/pdez_measurementerror/National_Causal-master/gpscausal_rm_strata_trim1.RData'
)
#Plots
#all
require(ggplot2)
...
save(match_pop_all_noncompile_notrim, match_pop_all_noncompile_onehot, match_pop_all_noncompile_trim,
     ...
     match_pop_asian_female_noncompile_notrim, match_pop_asian_female_noncompile_onehot, match_pop_asian_female_noncompile_trim,
     match_pop_asian_male_noncompile_notrim, match_pop_asian_male_noncompile_onehot, match_pop_asian_male_noncompile_trim,
     file='/nfs/home/P/prd789/shared_space/ci3_analysis/pdez_measurementerror/National_Causal-master/gpscausal_rm
     _strata_trim1.RData'
)

load('/nfs/home/P/prd789/shared_space/ci3_analysis/pdez_measurementerror/National_Causal-master/gpscausal_rm_strata_trim1.RData')